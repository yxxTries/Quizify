  ...
  return (
    <div style={styles.overlay} onClick={loading ? undefined : onClose}>
      ...
      <div style={styles.modal} onClick={(event) => event.stopPropagation()}>
        <p style={styles.kicker}>Edit Settings</p>
        <h2 style={styles.title}>{type === "discover" ? "Edit Discover Post" : "Edit Game Details"}</h2>
        <p style={styles.body}>
          Update the title and category for this quiz.
        </p>
...
const styles = {
  ...
  title: { margin: "10px 0 8px", fontSize: "28px", lineHeight: 1.1, fontFamily: FONTS.display },
  body: { margin: 0, color: COLORS.inkSoft, fontSize: "14px" },
  form: { display: "grid", gap: "14px", marginTop: "18px" },
  label: { display: "grid", gap: "8px", fontSize: "13px", color: COLORS.ink, fontWeight: 700 },
  input: { borderRadius: "10px", border: `1px solid ${COLORS.border}`, background: COLORS.cream, color: COLORS.ink, padding: "11px 12px", fontSize: "14px", outline: "none", fontFamily: "inherit" },
  select: { borderRadius: "10px", border: `1px solid ${COLORS.border}`, background: COLORS.cream, color: COLORS.ink, padding: "11px 12px", fontSize: "14px", outline: "none", fontFamily: "inherit" },
  error: { marginTop: "14px", borderRadius: "10px", border: `1px solid ${COLORS.coral}`, background: COLORS.coralSoft, color: COLORS.coralDark, padding: "10px 12px", fontSize: "13px", fontWeight: 600 },
